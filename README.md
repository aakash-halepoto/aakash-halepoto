...
I'm Aakash Sindhi, a Software Engineer from Pakistan transitioning into AI Engineering, focused on Generative and Agentic AI.

- 🔭 Currently building daily Python and GenAI projects in public → [python-for-genai](https://github.com/aakash-halepoto/python-for-genai)
- 🌱 Learning the AI engineering stack: Python, LLM APIs, RAG, and AI agents
- 🧠 Background: Machine Learning basics (NumPy, Pandas, Scikit-learn) and mobile development with Flutter
- 💼 Previously: Computer Lab Engineer at SZABIST University, Junior Software Engineer (Flutter)
